...
SNSService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_MirrorPost_(SNSService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status SNSService::Stub::MirrorPost(::grpc::ClientContext* context, const ::csce438::Message& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csce438::Message, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_MirrorPost_, context, request, response);
}

void SNSService::Stub::async::MirrorPost(::grpc::ClientContext* context, const ::csce438::Message* request, ::csce438::Reply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csce438::Message, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_MirrorPost_, context, request, response, std::move(f));
}

void SNSService::Stub::async::MirrorPost(::grpc::ClientContext* context, const ::csce438::Message* request, ::csce438::Reply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_MirrorPost_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::PrepareAsyncMirrorPostRaw(::grpc::ClientContext* context, const ::csce438::Message& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csce438::Reply, ::csce438::Message, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_MirrorPost_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::AsyncMirrorPostRaw(::grpc::ClientContext* context, const ::csce438::Message& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncMirrorPostRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
SNSService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce438::Message, ::csce438::Reply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SNSService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csce438::Message* req,
             ::csce438::Reply* resp) {
               return service->MirrorPost(ctx, req, resp);
             }, this)));
}
...
::grpc::Status SNSService::Service::MirrorPost(::grpc::ServerContext* context, const ::csce438::Message* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
